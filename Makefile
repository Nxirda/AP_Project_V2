...
Base :
	$(CC) -g3 -Wall -Wextra -Ofast -mavx2 -g Base_Implem.c -o Base -lyhash -Lyhash/ -lm -lpthread -fopenmp

MPI1 :
	$(CC_MPI) -g3 -Wall -Wextra -Ofast -mavx2 -g MPI_V1.c -o MPI1 -lyhash -Lyhash/ -lm -lpthread -fopenmp

MPI2 :
	$(CC_MPI) -g3 -Wall -Wextra -Ofast -mavx2 -g MPI_V2.c -o MPI2 -lyhash -Lyhash/ -lm -lpthread -fopenmp
